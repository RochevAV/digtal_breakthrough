    ...
    extension ModuleTransitionable where Self: UIViewController {
        ...
        func addChild(module: UIViewController) {
            ...
            NSLayoutConstraint.activate([
                module.view.topAnchor.constraint(equalTo: view.topAnchor, constant: 0),
                module.view.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: 0),
                module.view.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 0),
                module.view.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: 0)
                ])
        }
}
